...
export function getAvailableModels(session: ThreadSession, allowlist: string[] = []): Map<string, ModelInfo[]> {
  // Pi 0.84 exposes model discovery through modelRuntime.
  // Use the synchronous availability snapshot because this picker is
  // rendered from a Slack action handler.
